...
use step given below step 1:- open cmd and write npm i //this is installl all the packages is given in package.json

step 2:- import the database file on your local database like XAMPP phpmyadmin //this database filename is nodesequelize.sql

step 3:- import the collection file on your postman //this collection filename is sequelize.postman_collection.json
